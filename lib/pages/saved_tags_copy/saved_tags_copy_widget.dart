...
import 'saved_tags_copy_model.dart';
export 'saved_tags_copy_model.dart';
...
class SavedTagsCopyWidget extends StatefulWidget {
  const SavedTagsCopyWidget({super.key});

  static String routeName = 'SavedTagsCopy';
  static String routePath = '/savedTagsCopy';

  @override
  State<SavedTagsCopyWidget> createState() => _SavedTagsCopyWidgetState();
}

class _SavedTagsCopyWidgetState extends State<SavedTagsCopyWidget> {
  late SavedTagsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavedTagsCopyModel());
  }
                          ...
                          builder: (context) {
                            ...
                            return Column(
                              ...
                              children: List.generate(itemAtIndex.length,
                                ...
                                return TagIDWidget(
                                  key: Key(
                                      'Key6wc_${itemAtIndexIndex}_of_${itemAtIndex.length}'),
                                  name: _model.name
